    ...
    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-lg-6 mt-4">
                <h2 class="text-center pt-3">Nuevo sitio</h2>  
                <form action="<?=constant('URL')?>sitio/agregar" method="POST" id="frmSitios">
                    Sitio
                    <input type="text" class="form-control" name="txtSitio" data-validetta="required,minLength[3],maxLength[50]">
                    Descripcion
                    <input type="text" class="form-control" name="txtDesc" data-validetta="required,minLength[3],maxLength[100]">
                    Pais                    
